				...
				<ul>
					<li><span class="dropcap">1.</span>  
					   <div class="item_content">
						<h5>Job Searching</h5> 
						<p>Our Portal comprises of companies from any industries.</p>
					   </div>
					</li>
			    </ul>
			</div>
				...
				<ul>
					<li><span class="dropcap">2.</span>  
					   <div class="item_content">
						...
						<p>Login with an account and job application is just a click away.</p>
  			...
  			<div class="list styled custom-list custom-list1">
				<ul>
					<li><span class="dropcap">3.</span>  
					   <div class="item_content">
						<h5>Job Matching</h5> 
						<p>Jobs will be automatically matched by our smart system. Once matched, employer will be informed of the applicants matched.</p>
					   </div>
					</li>
			    </ul>
			</div>
				   	    ...
				   	    <div class="banner-wrap">
				   	 	    <ul class="grid-1">
				   	 			...
				   	 			<li class="grid-1_right">
				   	 				<p>Job Portal is a great platform for me to advertise my job online! Great!</p>
								      <h4><a href="#">Alicia</a> | Accenture HR</h4>
				   	 			</li>
				   	 			<div class="clearfix"> </div>
				   	 		</ul>
				   	    </div>
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	    <div class="banner-wrap">
				   	 	    <ul class="grid-1">
				   	 			...
				   	 			<li class="grid-1_right">
				   	 				<p>Great tool for posting job offers!</p>
								      <h4><a href="#">John doe</a> | Exonmobil</h4>
				   	 			</li>
				   	 			<div class="clearfix"> </div>
				   	 		</ul>
				   	    </div>
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	    <div class="banner-wrap">
				   	 	    <ul class="grid-1">
				   	 			...
				   	 			<li class="grid-1_right">
				   	 				<p>Received a job offer through this portal. Nice job portal!</p>
								      <h4><a href="#">annette Doe</a> | Applicant</h4>
				   	 			</li>
				   	 			<div class="clearfix"> </div>
				   	 		</ul>
				   	    </div>
